...
class FloorPlanEntity {
  ...
  static FloorPlanEntity defaultFloorPlan = FloorPlanEntity(
    imagePath: "",
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
    ...
    'canvasPan': <String, double>{
      'dx': canvasPan.dx,
      'dy': canvasPan.dy,
    },
  };

  factory FloorPlanEntity.fromJson(Map<String, dynamic> json) {
    ...
    return FloorPlanEntity(
      ...
      canvasPan: Offset(
        (pan['dx'] as num).toDouble(),
        (pan['dy'] as num).toDouble(),
      ),
    );
  }
}
