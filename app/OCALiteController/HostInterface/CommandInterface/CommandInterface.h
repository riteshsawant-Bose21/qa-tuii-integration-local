...
{
    CTRL_CMD_MIN       = 0,
    CTRL_CMD_ZONE_NAME_SET,    // "name" (max 8 chars)
    CTRL_CMD_SOURCE_COUNT_SET, // <uint32>
    CTRL_CMD_SOURCE_1_SET,     // "name" (max 8 chars)
    CTRL_CMD_SOURCE_2_SET,     // "name" (max 8 chars)
    CTRL_CMD_SOURCE_3_SET,     // "name" (max 8 chars)
    CTRL_CMD_SOURCE_4_SET,     // "name" (max 8 chars)
    CTRL_CMD_SOURCE_5_SET,     // "name" (max 8 chars)
