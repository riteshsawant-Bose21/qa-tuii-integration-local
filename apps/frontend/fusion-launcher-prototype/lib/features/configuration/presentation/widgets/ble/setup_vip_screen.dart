...
import 'package:fusion_design_tool_prototype/core/ble/ble_connection_manager.dart';
...
import '../../../../../core/ble/commands/fusion_commands.dart';
...
class _VipConfigurationState extends State<VipConfiguration> {
  ...
  void _setVIP() async {
    ...
    final ResponseCallback<dynamic> response = await serviceLocator<FusionBleCommands>()
        .updateFusionVIP(_vipController.text.trim());
