...
import 'package:fusion_design_tool_prototype/core/models/mix_entity.dart';
...
import 'package:fusion_design_tool_prototype/core/widgets/collapsible_side_panel.dart';
import 'package:fusion_design_tool_prototype/features/configuration/presentation/widgets/dsp_setup/dsp_column.dart';
...
class AudioSystemDesignPageState extends State<AudioSystemDesignPage> {
  ...
  final TextEditingController _droAddressController = TextEditingController(text: serviceLocator<AppSettings>().droServerUrl);
  final TextEditingController _virtualIPController = TextEditingController();
  final TextEditingController _backendUrlController = TextEditingController(text: serviceLocator<AppSettings>().fusionCloudBackendUrl);
  final TextEditingController _cloudWebUrlController = TextEditingController(text: serviceLocator<AppSettings>().cloudWebUrl);
                                ...
                                children: <Widget>[
                                  ...
                                  HorizontalResizableContainer(
                                    ...
                                    child: DspColumn(
                                      ...
                                      isControlMode: data.isInControlMode,
                                      droAddress: serviceLocator<AppSettings>().droServerUrl,
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    serviceLocator<AppSettings>().setFusionCloudBackendUrl(_backendUrlController.text);
                                  },
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: Colors.grey.shade800,
                                    foregroundColor: Colors.white,
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    serviceLocator<AppSettings>().setCloudWebUrl(_cloudWebUrlController.text);
                                  },
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: Colors.grey.shade800,
                                    foregroundColor: Colors.white,
