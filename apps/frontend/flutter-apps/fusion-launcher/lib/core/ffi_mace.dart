...
typedef AddSpeakerCluster = Uint64 Function(Uint64, Pointer<Utf8>, Double, Double, Double, Double);
typedef DartAddSpeakerCluster = int Function(int, Pointer<Utf8>, double, double, double, double);
...
class MaceEngine {
  ...
  int addSpeaker(String name, double x, double y, double z, double gain) {
    final Pointer<Utf8> namePtr = name.toNativeUtf8();
    final int id = maceAddSpeakerCluster(_handle, namePtr, x, y, z, gain);
    calloc.free(namePtr);
    return id;
  }
