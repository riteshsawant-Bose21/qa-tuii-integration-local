...
//                     height: 50,
//                     width: 200,
//                     activeBackgroundColor: Theme.of(context).colorScheme.primaryWhite,
//                     foregroundColor: Theme.of(context).colorScheme.primaryWhite,
//                     onTap: () {},
//                     showSuffixIcon: true,
...
//           const SizedBox(height: 8),
//           FusionAppText(
//             text: 'Current theme: ${colorScheme.isDarkMode ? 'Dark Mode' : 'Light Mode'}',
//             style: textTheme.bodyLarge?.copyWith(
//               color: colorScheme.greyDark,
//             ),
//           ),
//           FusionAppText(
//             text: 'Total colors: ${colorPalette.length}',
