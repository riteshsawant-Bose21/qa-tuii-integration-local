...
class SchematicPropertiesState extends State<SchematicProperties> {
  ...
  Widget build(BuildContext context) {
    ...
    final HardwareComponent? selectedDevice = projectViewModel.getHardware(hardwareId: selectedItem!.id);
      ...
      builder: (BuildContext context, dynamic state) {
        return Padding(
          ...
          child: Column(
            ...
            spacing: 10,
            children: <Widget>[
              Center(child: Image.asset(selectedDevice?.assetImagePath ?? '', width: 118)),
