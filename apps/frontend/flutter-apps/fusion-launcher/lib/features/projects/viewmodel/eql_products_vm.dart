    ...
    for (final AmplifierProduct element in datasource.amplifiers) {
      ...
      allProducts.add(
        EQLProduct(
          ...
          image: datasource.getAmplifierImage(element.productId),
    ...
    for (final IoEndpointProduct element in datasource.ioEndpoints) {
      ...
      allProducts.add(
        EQLProduct(
          ...
          name: element.modelName,
          modelFamily: element.modelFamily ?? '',
          image: datasource.getIoEndpointImage(element.productId),
          data: element,
    ...
    for (final DspProduct element in datasource.dsps) {
      ...
      allProducts.add(
        EQLProduct(
          ...
          portData: element.numberOfInputsAndOutputs ?? ProductPortData(),
          name: element.modelName,
          image: datasource.getDspImage(element.productId),
          modelFamily: element.modelFamily,
          data: element,
          searchingFields: '${element.modelName} ${element.modelFamily}',
