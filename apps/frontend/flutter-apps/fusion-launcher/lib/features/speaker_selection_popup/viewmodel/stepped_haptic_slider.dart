...
class _DemoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MaterialApp(
    title: 'SteppedHapticSlider Demo',
...
class _DemoPageState extends State<_DemoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFF111111),
        title: const Text('SteppedHapticSlider'),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            _label('Frequency — 50–100 Hz, step 10'),
            ...
            SteppedHapticSlider(
              ...
              interval: 10,
              initialValue: 70,
              onChanged: (double v) => setState(() => _freq = v),
            ),
            const SizedBox(height: 4),
            _value('${_freq.toInt()} Hz'),

            const SizedBox(height: 40),

            _label('Gain — 0–9, step 1'),
            const SizedBox(height: 8),
            SteppedHapticSlider(
              min: 0,
              max: 9,
              interval: 1,
              initialValue: 3,
              onChanged: (double v) => setState(() => _gain = v),
            ...
            _label('Pitch — 100–500 Hz, step 50, amber'),
            const SizedBox(height: 8),
            SteppedHapticSlider(
              min: 100,
              max: 500,
              ...
              trackFillColor: const Color(0xFFFFAB40),
              thumbDiameter: 32,
              tickHeight: 14,
              hapticFeedbackType: HapticFeedbackType.medium,
            ),
            const SizedBox(height: 4),
            _value('${_pitch.toInt()} Hz'),
          ],
        ),
      ),
    );
