...
class _SchematicsListingviewState extends State<SchematicsListingview> {
  ...
  final String _controllersSearchQuery = '';

  /// Accessories search state
  final String _accessoriesSearchQuery = '';
  DeviceSearchScope? _accessoriesSearchScope;

  ///Speakers search state
  final String _speakersSearchQuery = '';
    ...
    return BlocBuilder<ProjectViewModel, ProjectViewModelState>(
      builder: (BuildContext context, ProjectViewModelState state) {
        final List<Zone> filteredZones =
            _projectViewModel.zones.where((Zone z) => _speakersSearchQuery.isEmpty || z.name.toLowerCase().contains(_speakersSearchQuery)).toList();
        ...
        return ReorderableListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return ReorderableDragStartListener(
              ...
              index: index,
              child: Padding(
                padding: EdgeInsets.only(bottom: filteredZones.length - 1 == index ? 0.0 : 8.0),
                child: ExpandableZoneWidget(
                  ...
                  onDelete: (String id) {
                    ...
                    FusionToast.error(context, message: 'Zone "${zoneData.name}" deleted');
                  },
                ),
              ),
            );
