...
class OlsSchematicsPage extends StatefulWidget {
  const OlsSchematicsPage({super.key});

  @override
  OlsSchematicsPageState createState() => OlsSchematicsPageState();
}

class OlsSchematicsPageState extends State<OlsSchematicsPage> {
