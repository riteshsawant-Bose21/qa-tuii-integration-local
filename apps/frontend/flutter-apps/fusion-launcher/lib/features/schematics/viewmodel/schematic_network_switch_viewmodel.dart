...
class SchematicNetworkSwitchesViewModel extends DeviceListingViewModel<NetworkSwitch> {
  @override
  List<NetworkSwitch> fetchDevices(String query) {
    return NetworkSwitchSearchUseCase().call(
      query,
