  ...
  Widget build(BuildContext context) {
    ...
    switch (value.valueType) {
      ...
      case SceneParamValueType.dropdownSingle:
        ...
        return SemanticHelper.button(
          testId: SemanticHelper.createTestId(SemanticTypes.button, "event_action_type_dropdown"),
        ...
        return SizedBox(
          ...
          child: Transform.scale(
            ...
            child: SemanticHelper.formControl(
              testId: SemanticHelper.createTestId(SemanticTypes.textInput, "event_value_text_input"),
              child: TextFormField(
            ...
            Expanded(
              child: SizedBox(
                ...
                child: Transform.scale(
                  ...
                  scale: 0.9,
                  child: SemanticHelper.formControl(
                    testId: SemanticHelper.createTestId(SemanticTypes.textInput, "event_value_pulse_duration"),
                    child: TextFormField(
