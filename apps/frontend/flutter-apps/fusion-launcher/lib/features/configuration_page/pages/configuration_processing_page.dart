...
class _ConfigurationProcessingPageState
  ...
  void _scrollZoneIntoView(String zoneId) {
    ...
    try {
      ...
      final Offset zonePosition = renderObject.localToGlobal(
        Offset.zero,
      ...
      final List<SubZone> subZones = _projectViewModel.getSubZonesForZone(
        parentZoneId: zoneId,
      );
      final double expandedContentHeight = (subZones.length * 100.0).clamp(
        200.0,
        400.0,
      );
      ...
      targetScrollPosition = targetScrollPosition.clamp(
        0.0,
        _zonesScrollController.position.maxScrollExtent,
      );
      ...
      final int zoneIndex = _projectViewModel.zones.indexWhere(
    ...
    return Scaffold(
      ...
      body: SemanticHelper.container(
        testId: SemanticHelper.createTestId(
          ...
          FusionTestKeys.instance.sourcesec,
        ),
        child: LayoutBuilder(
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          SemanticHelper.textInput(
            testId: SemanticHelper.createTestId(
              SemanticTypes.textInput,
              FusionTestKeys.instance.sourcesearch,
            ),
          ...
          SemanticHelper.container(
            testId: SemanticHelper.createTestId(
              SemanticTypes.container,
              FusionTestKeys.instance.sourcelist,
            ),
                    ...
                    builder: (
                      ...
                      if (_filteredSources.isEmpty) {
                        return SemanticHelper.staticText(
                          testId: SemanticHelper.createTestId(
                            SemanticTypes.text,
                            FusionTestKeys.instance.sourceempty,
                          ),
                          child: Center(
                            child: FusionAppText(
                              text:
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return Draggable<Source>(
                            ...
                            childWhenDragging: SemanticHelper.container(
                              testId: SemanticHelper.createTestId(
                                SemanticTypes.container,
                                FusionTestKeys.instance.sourcechildWhenDragging,
                              ),
                            ...
                            child: SemanticHelper.container(
                              testId: SemanticHelper.createTestId(
                                SemanticTypes.container,
                                FusionTestKeys.instance.sourcelistitems,
                              ),
                              child: SourceItem(
                                index: index,
                                source: source,
              ...
              trailing: PopupMenuButton<dynamic>(
                ...
                child: SemanticHelper.button(
                  testId: SemanticHelper.createTestId(
                    ...
                    FusionTestKeys.instance.sourcesetheadicon,
                  ),
                  child: IconButton(
                    icon: Icon(
                      Icons.add_sharp,
          ...
          Expanded(
            child: SemanticHelper.container(
              testId: SemanticHelper.createTestId(
                SemanticTypes.container,
                FusionTestKeys.instance.sourcesedata,
              ),
              child: Container(
                decoration: BoxDecoration(
                ...
                child: BlocBuilder<ProjectViewModel, ProjectViewModelState>(
                  builder: (
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              SemanticHelper.staticText(
                                testId: SemanticHelper.createTestId(
                                  SemanticTypes.text,
                                  FusionTestKeys.instance.emtysourcesethead,
                                ),
                                child: FusionAppText(
                              ...
                              SemanticHelper.container(
                                testId: SemanticHelper.createTestId(
                                  SemanticTypes.container,
                                  FusionTestKeys.instance.emtysourcesetdesc2,
                                ),
                                child: FusionAppText(
                                  text:
                    ...
                    return SemanticHelper.container(
                      testId: SemanticHelper.createTestId(
                        SemanticTypes.container,
                        FusionTestKeys.instance.srcsetlist,
                      ),
                      child: Container(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return DragTarget<Source>(
                              ...
                              onAccept: (Source data) {
                                _projectViewModel.addSourceToSourceSet(
                                  sourceId: data.id,
                                  sourceSetId: sourceSet.id,
                                );
        ...
        child: Column(
          children: <Widget>[
            ...
            SemanticHelper.container(
              testId: SemanticHelper.createTestId(
                SemanticTypes.container,
                FusionTestKeys.instance.zonehead,
              ),
              child: const SectionHeader(
                title: 'Zones',
                ...
                builder: (BuildContext context, ProjectViewModelState state) {
                  return _projectViewModel.zones.isEmpty
                      ? SemanticHelper.container(
                        testId: SemanticHelper.createTestId(
                          SemanticTypes.container,
                          FusionTestKeys.instance.zoneempty,
                        ),
                        child: Padding(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return ReorderableDragStartListener(
                              ...
                              child: SemanticHelper.container(
                                testId: SemanticHelper.createTestId(
                                  SemanticTypes.container,
                                  '${FusionTestKeys.instance.zonelist}_$index',
                                ),
                                child: ZoneCard(
                                  key: zoneKey,
                                  zoneId: zoneData.id,
...
class _SourceSetCreationWidgetState extends State<_SourceSetCreationWidget> {
  ...
  Widget build(BuildContext context) {
    return SemanticHelper.container(
      testId: SemanticHelper.createTestId(
        SemanticTypes.container,
        FusionTestKeys.instance.srccreation,
      ),
      child: Container(
        color: context.colorScheme.elevation1,
        width: 250,
        ...
        child: Column(
          ...
          children: <Widget>[
            SemanticHelper.container(
              testId: SemanticHelper.createTestId(
                SemanticTypes.container,
                FusionTestKeys.instance.srccreationhead,
              ),
              child: FusionAppText(
            ...
            SemanticHelper.staticText(
              testId: SemanticHelper.createTestId(
                SemanticTypes.text,
                FusionTestKeys.instance.srcnamelabel,
              ),
              child: FusionAppText(
            ...
            Container(
              ...
              child: PopupMenuButton<String>(
                      ...
                      child: StatefulBuilder(
                        builder: (
                          ...
                          return SemanticHelper.container(
                            testId: SemanticHelper.createTestId(
                              SemanticTypes.container,
                              FusionTestKeys.instance.srccreationdropdown,
                            ),
                            child: Container(
                              width: 240,
                                                ...
                                                children:
                                                    ...
                                                    >((Source source) {
                                                      ...
                                                      return SemanticHelper.button(
                                                        testId: SemanticHelper.createTestId(
                                                          SemanticTypes.button,
                                                          "${FusionTestKeys.instance.srccreationdropdownitem}_$index",
                                                        ),
                                                        child: InkWell(
                                                          onTap: () {
                                                            widget
                ...
                child: SemanticHelper.button(
                  testId: SemanticHelper.createTestId(
                    SemanticTypes.button,
                    FusionTestKeys.instance.srcdropdown,
                  ),
                  child: Container(
                    height: 29,
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        SemanticHelper.image(
                          testId: SemanticHelper.createTestId(
                            SemanticTypes.icon,
                            FusionTestKeys.instance.srcdropdownicon,
                          ),
                          child: Icon(
              ...
              children: <Widget>[
                Flexible(
                  child: FusionOutlinedButton(
                    accessLabel: FusionTestKeys.instance.srccreationheadcancel,
                ...
                Flexible(
                  child: FusionButton(
                    width: double.infinity,
                    accessLabel: FusionTestKeys.instance.srccreationheadcreate,
