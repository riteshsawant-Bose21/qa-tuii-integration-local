            ...
            children: <Widget>[
              Padding(
                ...
                child: FusionGradientText(
                  text: 'Surface Speaker Layout Calculator',
                  fontSize: 25,
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Wrap(
            spacing: 8.0,
            children:
                CoveragePreference.values.map((CoveragePreference preference) {
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          _buildCalculationStep(
            ...
            calculation:
                'Horizontal_coverage = 2 × tan(${double.parse(_coverageAngleController.text)}°/2) × ${_result!.distanceToListenerPlane.toStringAsFixed(2)}\n'
...
class RoomLayoutPainter extends CustomPainter {
  ...
  void _drawDirectionalCoverage(Canvas canvas, double offsetX, double offsetY, double roomLength, double roomWidth, double scale) {
    ...
    final Paint coverageStrokePaint =
        Paint()
    ...
    for (final SpeakerPosition position in result.positions) {
      ...
      if (onFrontWall) {
        ...
        _drawSectorCoverage(
          ...
          coverageDistance,
          coverageWidth,
          90, // 90 degrees = pointing down into room
          coveragePaint,
          coverageStrokePaint,
        );
      } else if (onBackWall) {
        ...
        _drawSectorCoverage(
          ...
          coverageDistance,
          coverageWidth,
          270, // 270 degrees = pointing up into room
          coveragePaint,
          coverageStrokePaint,
        );
      } else if (onLeftWall) {
        ...
        _drawSectorCoverage(
          ...
          coverageDistance,
          coverageWidth,
          0, // 0 degrees = pointing right into room
          coveragePaint,
          coverageStrokePaint,
        );
      } else if (onRightWall) {
        ...
        _drawSectorCoverage(
          ...
          coverageDistance,
          coverageWidth,
          180, // 180 degrees = pointing left into room
          coveragePaint,
          coverageStrokePaint,
        );
      }
  ...
  void _drawSpeakers(Canvas canvas, double offsetX, double offsetY, double scale) {
    ...
    final Paint speakerBorderPaint =
        Paint()
