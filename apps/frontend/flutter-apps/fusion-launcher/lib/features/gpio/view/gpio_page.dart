...
class GpioPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SemanticHelper.container(
      testId: SemanticHelper.createTestId(SemanticTypes.container, "gpio_page"),
      child: Container(
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: FusionAppText(
                                          semanticId: 'gpio_header_count',
                                          text: "${state.availableGPIOPorts.abs()}",
                                ...
                                SemanticHelper.button(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: FusionIcon.icon(
                                      semanticId: 'add_gpio_header_icon',
                                      Icons.add,
                                      color: Colors.grey,
                                    ),
                                  ),
                          ...
                          child: Builder(
                            builder: (BuildContext context) {
                              if (state.gpios.isEmpty) {
                                return Center(
                                  child: FusionAppText(
                                    semanticId: 'no_gpio_text',
                                    text: "No GPIOs Configured",
                                    style: context.textTheme.bodyMedium,
                                  ),
                                );
                              }
                              return SemanticHelper.container(
                                testId: SemanticHelper.createTestId(SemanticTypes.container, "gpio_table"),
                                child: FusionAppTable(
