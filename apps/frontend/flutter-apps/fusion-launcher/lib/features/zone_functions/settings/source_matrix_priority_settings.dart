...
import 'source_select_priority_settings.dart';

class SourceMatrixPrioritySettings extends StatefulWidget {
  final String zoneID;

  const SourceMatrixPrioritySettings({super.key, required this.zoneID});
  ...
  static void showDialog(BuildContext context, {required String zoneID}) {
    showGeneralDialog(
      ...
      pageBuilder: (BuildContext buildContext, _, __) {
        return SourceMatrixPrioritySettings(
          zoneID: zoneID,
        );
      },
    );
  ...
  @override
  State<SourceMatrixPrioritySettings> createState() => _SourceMatrixPrioritySettingsState();
}

class _SourceMatrixPrioritySettingsState extends State<SourceMatrixPrioritySettings> {
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Flexible(
                                        flex: 2,
                                        child: PriorityZoneSubZoneSettingBuilder(zoneID: widget.zoneID),
                                      ),
                                    ],
                                  ),
                                ),
