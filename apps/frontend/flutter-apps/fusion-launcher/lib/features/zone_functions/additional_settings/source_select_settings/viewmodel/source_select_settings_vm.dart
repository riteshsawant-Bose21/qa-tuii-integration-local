...
class SourceSelectAdditionalSettingsViewmodel extends Cubit<SourceSelectAdditionalSettingsVmState> {
  ...
  void toggleUseOff() => emit(state.copyWith(useOff: !state.useOff));
  void toggleUseCrossfade() => emit(state.copyWith(useCrossfade: !state.useCrossfade));

  void toggleSourceSelect(String sourceId) {
    final List<String> selectedSourcesIds = <String>[...state.selectedSourcesIds];
    ...
    emit(state.copyWith(selectedSourcesIds: selectedSourcesIds));
  }
