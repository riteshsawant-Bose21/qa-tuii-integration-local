...
class _CanvasView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SemanticHelper.container(
      testId: SemanticHelper.createTestId(SemanticTypes.section, "canvas_view"),
      child: ClipRect(
        child: Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: FusionKeyboardWrapper(
                              ...
                              child: DragTarget<_PBItemWrapper>(
                                onAcceptWithDetails: (
                                  DragTargetDetails<_PBItemWrapper> details,
                                ) {
                                  final String type =
                                      details.data.parameter?.valueType ??
                                      details.data.telemetry?.valueType ??
                                      "";
                                  ...
                                  if (details.data.parameter != null &&
                                    ...
                                    availableTypes.addAll(
                                      PbWidgets.selectWidgets,
                                    );
                                  }
                                  availableTypes.addAll(
                                    PbWidgets.genericWidgets,
                                  );
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: <Widget>[
                                              FusionAppText(
                                                text:
                                                    "Select How do you want to represent '${details.data.name}'",
                                                style:
                                                    context
                                                        .textTheme
                                                        .titleLarge,
                                ...
                                builder: (
                                  BuildContext context,
                                  List<_PBItemWrapper?> candidateData,
                                  ...
                                  return Stack(
                                    ...
                                    children: <Widget>[
                                      ...
                                      for (final PBItem selected
                                          in viewModel.selectedItems)
