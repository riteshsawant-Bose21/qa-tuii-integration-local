      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          FusionNeumorphicButton(
            ...
            onTap: () {
              context.read<AgcController>().addBand();
            },
          ),
        ],
      ),
...
class _PEQGraph extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Consumer<AgcController>(
      builder: (BuildContext context, AgcController controller, Widget? child) {
  ...
  void _handleDragStart(DragStartDetails details, AgcController controller, List<_PEQDataPoint> tableData, BuildContext context) {
  ...
  void _handleDragUpdate(DragUpdateDetails details, AgcController controller, List<_PEQDataPoint> tableData, BuildContext context) {
