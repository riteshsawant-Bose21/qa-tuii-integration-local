                                          ...
                                          builder: (BuildContext context, AddSourceViewModelState state) {
                                            ...
                                            return BuildRowPropertyWidget<dynamic>(
                                              ...
                                              valueBuilder: (dynamic option) {
                                                ...
                                                return Text((option as Aes67Config).name);
                                              },
                                            ...
                                            children: <Widget>[
                                              ...
                                              Expanded(
                                                child: _ChannelDropdown(
                                                  value: state.selectedMonoChannel,
                                                  channelConfigs: state.selectedStream?.channelConfigs ?? <Aes67ChannelConfig>[],
                                                  onChanged: (int? v) {
                                                    if (v != null) addSourceViewModel.setSelectedMonoChannel(v);
                                                  },
                                                ),
                                              ),
                                            ],
                                        ...
                                        if (state.selectedSignalType == SignalType.stereo) ...<Widget>[
                                          ...
                                          Row(
                                            children: <Widget>[
                                              ...
                                              Expanded(
                                                child: _ChannelDropdown(
                                                  value: state.selectedLeftChannel,
                                                  channelConfigs: state.selectedStream?.channelConfigs ?? <Aes67ChannelConfig>[],
                                                  onChanged: (int? v) {
                                                    if (v != null) addSourceViewModel.setSelectedLeftChannel(v);
                                                  },
                                                ),
                                              ),
                                            ],
                                          ...
                                          Row(
                                            children: <Widget>[
                                              ...
                                              Expanded(
                                                child: _ChannelDropdown(
                                                  value: state.selectedRightChannel,
                                                  channelConfigs: state.selectedStream?.channelConfigs ?? <Aes67ChannelConfig>[],
                                                  onChanged: (int? v) {
                                                    if (v != null) addSourceViewModel.setSelectedRightChannel(v);
                                                  },
                                                ),
                                              ),
                                            ],
...
/// Channel dropdown widget matching input_stream_dialog pattern
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<int>(
          value: (value != null && configs.any((Aes67ChannelConfig c) => c.channelNumber == value)) ? value : null,
          hint: FusionAppText(
            text: 'Assign',
          ...
          items:
              configs
                  .map(
                    (Aes67ChannelConfig c) => DropdownMenuItem<int>(
                      value: c.channelNumber,
                      child: FusionAppText(
                        text: c.label ?? 'Channel ${c.channelNumber}',
                        style: context.textTheme.bodySmall?.copyWith(
                          color: context.colorScheme.textPrimary,
                        ),
                      ),
