...
class _QRClaimPopupState extends State<QRClaimPopup> {
  ...
  @override
  void initState() {
    claimUrl = "http://${serviceLocator<AppSettings>().cloudWebUrl}/claim/${widget.deviceIdToClaim}?token=${serviceLocator<SharedPreferencesHandler>().getString(SharedPreferenceKeys.accessToken)}";
    super.initState();
  }
