...
import 'package:fusion_design_tool_prototype/core/router/routes.dart';
...
import 'package:fusion_design_tool_prototype/core/widgets/animated_action_widget.dart';
import 'package:fusion_design_tool_prototype/core/widgets/app_text_view.dart';
import 'package:fusion_design_tool_prototype/core/widgets/gradient_action_button.dart';
import 'package:fusion_design_tool_prototype/features/user_account_setup/presentation/widgets/launcher_background.dart';
...
class _LauncherSignInPageState extends State<LauncherSignInPage> {
  ...
  void _showSettingsDialog(BuildContext context) {
    ...
    final TextEditingController droAddressController = TextEditingController(text: serviceLocator<AppSettings>().droServerUrl);
    final TextEditingController backendUrlController = TextEditingController(text: serviceLocator<AppSettings>().fusionCloudBackendUrl);
    final TextEditingController cloudWebUrlController = TextEditingController(text: serviceLocator<AppSettings>().cloudWebUrl);
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              ...
                              serviceLocator<AppSettings>().setDroServerUrl(ip);
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              serviceLocator<AppSettings>().setFusionCloudBackendUrl(backendUrlController.text);
                            },
                            style: ElevatedButton.styleFrom(
                              backgroundColor: Colors.grey.shade800,
                              foregroundColor: Colors.white,
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              serviceLocator<AppSettings>().setCloudWebUrl(cloudWebUrlController.text);
                            },
                            style: ElevatedButton.styleFrom(
                              backgroundColor: Colors.grey.shade800,
                              foregroundColor: Colors.white,
