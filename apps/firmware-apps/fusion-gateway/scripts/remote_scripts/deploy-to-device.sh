#!/bin/bash
# filepath: deploy-fusion-gateway.sh
...
BUILD_SCRIPT="./build-fusion-gateway"
BUILD_DIR="./build"
BINARY_NAME="fusion-gateway_linux_arm64"
REMOTE_PATH="/usr/local/bin/fusion-gateway"
SERVICE_NAME="fusion-gateway"
...
build_local() {
    print_status "Building fusion-gateway locally..."
