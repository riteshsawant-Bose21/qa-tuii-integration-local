...
public:
    ...
    /// Test whether the algorithm has telemetry definitions.
    ///
    /// @return  True if the algorithm has telemetry definitions, false
    ///          otherwise.
    ...
    /// Get the telemetry definitions for the algorithm.  The telemetry definitions
    /// must exist: use `has_telemetry()` to test for their existence before
    /// calling this method.
    ///
    /// @return  The telemetry definitions for the algorithm.
    const TelemetryParameter &get_telemetry() const
    {
        return (const TelemetryParameter &)get_member("telemetry");
    }
};
...
class TelemetryParameter : public Parameters {
    /// Test whether the algorithm has telemetry_type.
    ///
    /// @return  True if the algorithm has telemetry_type, false
    ///          otherwise.
    bool has_telemetry_type() const
    {
        return has_member("telemetry_type");
    }
