                             ...
                             const BlockConfiguration *configuration)
{
    ...
    case 0:
        if (value_type == "bool")
        {
            return new ParameterDataScalar<bool>(definition, processor,
                                                 configuration);
        }
        else if (value_type == "integer")
        {
            return new ParameterDataScalar<int_fast32_t>(definition, processor,
                                                         configuration);
        }
        else if (value_type == "float")
        {
            return new ParameterDataScalar<float>(definition, processor,
                                                  configuration);
        }
        else if (value_type == "string")
        {
            return new ParameterDataScalar<std::string>(definition, processor,
                                                        configuration);
        }
        break;
    ...
    case 1:
        if (value_type == "bool")
        {
            return new ParameterDataVector<bool>(definition, processor,
                                                 configuration);
        }
        else if (value_type == "integer")
        {
            return new ParameterDataVector<int_fast32_t>(definition, processor,
                                                         configuration);
        }
        else if (value_type == "float")
        {
            return new ParameterDataVector<float>(definition, processor,
                                                  configuration);
        }
        else if (value_type == "string")
        {
            return new ParameterDataVector<std::string>(definition, processor,
                                                        configuration);
        }
        break;
    ...
    case 2:
        if (value_type == "bool")
        {
            return new ParameterDataMatrix<bool>(definition, processor,
                                                 configuration);
        }
        else if (value_type == "integer")
        {
            return new ParameterDataMatrix<int_fast32_t>(definition, processor,
                                                         configuration);
        }
        else if (value_type == "float")
        {
            return new ParameterDataMatrix<float>(definition, processor,
                                                  configuration);
        }
        else if (value_type == "string")
        {
            return new ParameterDataMatrix<std::string>(definition, processor,
                                                        configuration);
        }
        break;
