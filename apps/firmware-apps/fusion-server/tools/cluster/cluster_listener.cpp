...
//{"event":"gained","host":"192.168.64.4","timestamp":1760577087,"vip":"192.168.64.100"}
...
int main(int argc, char* argv[])
{
    ...
    std::cout << "Listening for IPv4 heartbeats on UDP port "
              << port << "..." << std::endl;
    ...
    while (keepRunning) {
        ...
        try {
            ...
            std::cout << "From [" << srcIP << "]:" << ntohs(srcAddr.sin_port) << std::endl;
