...
FILTERS = [
    ...
    {
        'name': 'PEQ_CS 1000Hz Q1.41 0dB',
        'b': [[1.0506491712772372, -1.9914081089643749, 0.95794271975838774]],
        'a': [[1.0506491712772372, -1.9914081089643749, 0.95794271975838774]],
        'color': 'blue',
        'linestyle': '-'
    },
    {
        'name': 'PEQ_CS 100Hz Q1.41 0dB',
        'b': [[1.0046716060770953, -1.9999143239039676, 0.99541407001893711]],
        'a': [[1.0046716060770953, -1.9999143239039676, 0.99541407001893711]],
        'color': 'blue',
        'linestyle': '--'
    },
    {
        'name': 'PEQ_CS 100Hz Q2.00 6dB',
    ...
    {
        'name': 'HPF_CS 80Hz Order 2',
        'b': [[0.99262254501386304, -2, 1]],
        'a': [[1, -1.9851906624116258, 0.98529951764382684]],
        'color': 'red',
        'linestyle': '-'
    },
    {
        'name': 'LPF_CS 12000Hz Order 2',
        'b': [[0.29289325635589886, 2, 1]],
        'a': [[1, -1.3007073478550298e-16, 0.17157302542359548]],
        'color': 'red',
        'linestyle': '--'
    },
    ...
    # Notch filters
    {
        'name': 'Notch_CS 1000Hz Q10.00',
        'b': [[0.99350218482156849, 1.9828897227476208, 1]],
        'a': [[1, 1.9700052718099954, -0.98700436964313709]],
        'color': 'purple',
        'linestyle': '-'
    },
    {
        'name': 'Notch_CS 500Hz Q2.00',
        'b': [[0.98390378528037614, 1.995717846477207, 1]],
        'a': [[1, 1.9635943435005245, -0.96780757056075239]],
        'color': 'purple',
        'linestyle': '--'
    }
    # {
...
# PLOTTING CODE
# ==============================================================================
def cascade_biquads_response(b_sections, a_sections, fs=48000, nfft=16384):
