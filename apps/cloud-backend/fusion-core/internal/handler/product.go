...
//	@Failure		500	{object}	types.InternalServerError "Internal server error"																							"Internal server error"
//	@Router			/products [get]
...
//	@Failure		400 {object} 	types.BadRequestError "Bad request - Invalid payload"																									"Bad request - Product ID is required"
//	@Failure		404	{object}	types.NotFoundError "Product not found"																								"Product not found"
//	@Failure		500	{object}	types.InternalServerError "Internal server error"																									"Internal server error"
...
//	@Failure		400			{object}	types.BadRequestError "Bad request - Invalid payload"																									"Bad request - Product ID is required"
//	@Failure		404			{object}	types.NotFoundError "Product price not found"																								"Product not found"
//	@Failure		500			{object}	types.InternalServerError "Internal server error"																									"Internal server error"
