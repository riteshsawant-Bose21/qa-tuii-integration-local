...
func (s *Service) Insert(ctx context.Context, userProfile *types.UserProfile) (string, error) {
...
func (s *Service) Update(ctx context.Context, userProfile *types.UserProfile) error {
	userProfileModel := &model.UserProfile{
		...
		UserID:                userProfile.UserID,
		Email:                 userProfile.Email,
		FirstName:             null.StringFrom(userProfile.FirstName),
		LastName:              null.StringFrom(userProfile.LastName),
		JobTitle:              null.StringFrom(userProfile.JobTitle),
		Phone:                 null.StringFrom(userProfile.Phone),
		ProfilePhotoURL:       null.StringFrom(userProfile.ProfilePhotoURL),
		AddressLine1:          null.StringFrom(userProfile.AddressLine1),
		City:                  null.StringFrom(userProfile.City),
		StateProvince:         null.StringFrom(userProfile.StateProvince),
		Country:               null.StringFrom(userProfile.Country),
		ZipPostalCode:         null.StringFrom(userProfile.ZipPostalCode),
		...
		Timezone:              null.StringFrom(userProfile.Timezone),
		UnitSystem:            null.StringFrom(userProfile.UnitSystem),
		CustomerType:          null.StringFrom(userProfile.CustomerType),
		ClientType:            null.StringFrom(userProfile.ClientType),
		CompanyName:           null.StringFrom(userProfile.CompanyName),
		CompanyWebsite:        null.StringFrom(userProfile.CompanyWebsite),
		Currency:              null.StringFrom(userProfile.Currency),
		NetsuiteCustomerID:    null.StringFrom(userProfile.NetsuiteCustomerID),
