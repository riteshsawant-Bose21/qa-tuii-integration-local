...
func (appUserL) LoadAccount(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAppUser any, mods queries.Applicator) error {
	var slice []*AppUser
	var object *AppUser
...
// loaded structs of the objects. This is for an N-1 relationship.
func (appUserL) LoadAccountTypeRole(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAppUser any, mods queries.Applicator) error {
	var slice []*AppUser
	var object *AppUser
...
func (appUserL) LoadLockedByUserProjects(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAppUser any, mods queries.Applicator) error {
	var slice []*AppUser
	var object *AppUser
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (appUserL) LoadUserProjectUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAppUser any, mods queries.Applicator) error {
	var slice []*AppUser
	var object *AppUser
