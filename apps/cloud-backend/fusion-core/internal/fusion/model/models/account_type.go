...
func (accountTypeL) LoadAccounts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAccountType any, mods queries.Applicator) error {
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (accountTypeL) LoadAccountTypeRoles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAccountType any, mods queries.Applicator) error {
	var slice []*AccountType
	var object *AccountType
