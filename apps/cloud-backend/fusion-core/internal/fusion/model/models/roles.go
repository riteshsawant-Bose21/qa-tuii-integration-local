...
func (o *Role) GetAccountTypeRoles() AccountTypeRoleSlice {
	if o == nil {
		return nil
	}
...
func (r *roleR) GetAccountTypeRoles() AccountTypeRoleSlice {
	if r == nil {
		return nil
	}
...
func (o *Role) GetFeaturePermissions() FeaturePermissionSlice {
	if o == nil {
		return nil
	}
...
func (r *roleR) GetFeaturePermissions() FeaturePermissionSlice {
	if r == nil {
		return nil
	}
...
func (o *Role) AccountTypeRoles(mods ...qm.QueryMod) accountTypeRoleQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"account_type_role\".\"role_id\"=?", o.ID),
	)
...
func (o *Role) FeaturePermissions(mods ...qm.QueryMod) featurePermissionQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"feature_permission\".\"role_id\"=?", o.ID),
	)
...
func (roleL) LoadAccountTypeRoles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
	...
	query := NewQuery(
		...
		qm.WhereIn(`account_type_role.role_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (roleL) LoadFeaturePermissions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
	...
	query := NewQuery(
		...
		qm.WhereIn(`feature_permission.role_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Role) AddAccountTypeRoles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*AccountTypeRole) error {
	var err error
...
// Sets related.R.Role appropriately.
func (o *Role) AddFeaturePermissions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*FeaturePermission) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.RoleID = o.ID
