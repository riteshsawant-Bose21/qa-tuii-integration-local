...
func (projectUserL) LoadProject(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProjectUser any, mods queries.Applicator) error {
...
// loaded structs of the objects. This is for an N-1 relationship.
func (projectUserL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProjectUser any, mods queries.Applicator) error {
	var slice []*ProjectUser
	var object *ProjectUser
