...
func (projectL) LoadLockedByUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProject any, mods queries.Applicator) error {
	var slice []*Project
	var object *Project
...
// loaded structs of the objects. This is for an N-1 relationship.
func (projectL) LoadPrimaryOwnerAccount(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProject any, mods queries.Applicator) error {
	var slice []*Project
	var object *Project
...
func (projectL) LoadProjectUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProject any, mods queries.Applicator) error {
	var slice []*Project
	var object *Project
