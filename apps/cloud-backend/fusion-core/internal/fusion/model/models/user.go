...
var UserWhere = struct {
	...
	FullName:     whereHelpernull_String{field: "\"user\".\"full_name\""},
	PasswordHash: whereHelpernull_String{field: "\"user\".\"password_hash\""},
	RoleID:       whereHelperint{field: "\"user\".\"role_id\""},
	AccountID:    whereHelperint{field: "\"user\".\"account_id\""},
...
func (o *User) GetRole() *AccountTypeRole {
	if o == nil {
		return nil
	}
...
func (r *userR) GetRole() *AccountTypeRole {
	if r == nil {
		return nil
	}
...
func (o *User) GetLockedByUserProjects() ProjectSlice {
	if o == nil {
		return nil
	}
...
func (r *userR) GetLockedByUserProjects() ProjectSlice {
	if r == nil {
		return nil
	}
...
func (r *userR) GetProjectUsers() ProjectUserSlice {
	if r == nil {
		return nil
	}
...
var (
	userAllColumns            = []string{"id", "email", "full_name", "password_hash", "role_id", "account_id", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"id", "email", "role_id", "account_id"}
	userColumnsWithDefault    = []string{"full_name", "password_hash", "created_at", "updated_at"}
...
func (o *User) Role(mods ...qm.QueryMod) accountTypeRoleQuery {
	queryMods := []qm.QueryMod{
...
func (o *User) LockedByUserProjects(mods ...qm.QueryMod) projectQuery {
...
func (userL) LoadLockedByUserProjects(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
func (o *User) SetRole(ctx context.Context, exec boil.ContextExecutor, insert bool, related *AccountTypeRole) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
func (o *User) AddLockedByUserProjects(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Project) error {
	var err error
...
func (o *User) SetLockedByUserProjects(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Project) error {
...
func (o *User) RemoveLockedByUserProjects(ctx context.Context, exec boil.ContextExecutor, related ...*Project) error {
	if len(related) == 0 {
		return nil
	}
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(userPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert user, could not build conflict column list")
			}
