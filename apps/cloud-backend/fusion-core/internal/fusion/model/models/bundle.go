...
var (
	bundleAllColumns            = []string{"id", "version", "version_array", "prerelease_tag", "prerelease_num", "release_notes", "min_prev_version", "min_prev_version_array", "min_desktop_app_version", "min_desktop_app_version_array", "manifest_data", "checksum", "s3_path", "approval_status", "approval_status_changed_by", "approval_status_changed_at", "created_at", "updated_at"}
	bundleColumnsWithoutDefault = []string{"version", "min_prev_version", "min_desktop_app_version", "checksum", "s3_path"}
	bundleColumnsWithDefault    = []string{"id", "version_array", "prerelease_tag", "prerelease_num", "release_notes", "min_prev_version_array", "min_desktop_app_version_array", "manifest_data", "approval_status", "approval_status_changed_by", "approval_status_changed_at", "created_at", "updated_at"}
