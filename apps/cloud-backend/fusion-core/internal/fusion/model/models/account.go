...
func (accountL) LoadAccountType(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAccount any, mods queries.Applicator) error {
	var slice []*Account
	var object *Account
...
func (accountL) LoadAppUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAccount any, mods queries.Applicator) error {
	var slice []*Account
	var object *Account
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (accountL) LoadPrimaryOwnerAccountProjects(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAccount any, mods queries.Applicator) error {
	var slice []*Account
	var object *Account
