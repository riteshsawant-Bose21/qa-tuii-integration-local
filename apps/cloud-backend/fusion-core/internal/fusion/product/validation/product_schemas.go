...
type Speaker struct {
	...
	PowerHandling        any    `json:"power_handling" validate:"optional,type:object" description:"Power handling specifications"`
	Sensitivity          any    `json:"sensitivity" validate:"optional,type:object" description:"Speaker sensitivity specifications"`
	FrequencyRange       any    `json:"frequency_range" validate:"optional,type:object" description:"Operating frequency range"`
	NominalImpedance     any    `json:"nominal_impedance" validate:"optional,type:object" description:"Nominal impedance specification"`
	MaxSPL               any    `json:"max_spl" validate:"optional,type:object" description:"Maximum sound pressure level"`
	Coverage             []any  `json:"coverage" validate:"optional,type:array" description:"Coverage pattern specifications"`
	Environment          string `json:"environment" validate:"optional,type:string" description:"Installation environment"`
	MountType            string `json:"mount_type" validate:"optional,type:string" description:"Mounting type"`
	IsSubwoofer          bool   `json:"is_subwoofer" validate:"optional,type:boolean" description:"Subwoofer indicator"`
	IsWeatherRated       bool   `json:"is_weather_rated" validate:"optional,type:boolean" description:"Weather resistance indicator"`
	IsHighImpedanceRated bool   `json:"is_high_impedance_rated" validate:"optional,type:boolean" description:"High impedance capability"`

	// Optional fields for speakers
	BSFFileURL        string `json:"bsf_file_url" validate:"optional,type:string,not_empty" description:"BSF configuration file URL"`
...
type Amplifier struct {
	...
	PowerOutput              any `json:"power_output" validate:"optional,type:object" description:"Power output specifications"`
	NumberOfInputsAndOutputs any `json:"number_of_inputs_and_outputs" validate:"optional,type:object" description:"Number of inputs and outputs"`
	PowerConsumption         any `json:"power" validate:"optional,type:object" description:"Power consumption specifications"`
	SpeakerInputs            int `json:"number_of_loudspeaker_inputs" validate:"optional,type:number" description:"Number of loudspeaker inputs"`
}
...
type DigitalSignalProcessor struct {
	...
	NumberOfInputsAndOutputs any `json:"number_of_inputs_and_outputs" validate:"optional,type:object" description:"Number of inputs and outputs"`
	MaxDigitalControl        int `json:"max_number_of_digital_control" validate:"optional,type:number" description:"Maximum digital control inputs"`
	MaxAnalogControl         int `json:"max_number_of_analog_control" validate:"optional,type:number" description:"Maximum analog control inputs"`
	GPIOLogicPorts           any `json:"gpio_logic_ports" validate:"optional,type:object" description:"GPIO logic port specifications"`
}
...
type Controller struct {
	...
	ZoneControlCount  string `json:"zone_control_count" validate:"optional,type:string" description:"Number of zones controllable"`
	ControlType       string `json:"control_type" validate:"optional,type:string" description:"Type of control interface"`
	AdditionalSensors []any  `json:"additional_sensors" validate:"optional,type:array" description:"Additional sensor capabilities"`
	PhysicalSize      string `json:"physical_size" validate:"optional,type:string" description:"Physical dimensions/form factor"`
	ApplicableRegions []any  `json:"applicable_regions" validate:"optional,type:array" description:"Supported geographic regions"`
}
...
type IOEndpoint struct {
	...
	Inputs  any  `json:"inputs" validate:"optional,type:object" description:"Input specifications"`
	Outputs any  `json:"outputs" validate:"optional,type:object" description:"Output specifications"`
	Network bool `json:"network" validate:"optional,type:boolean" description:"Network capability indicator"`
}
...
type Accessory struct {
	...
	Type     string `json:"type" validate:"optional,type:string" description:"Accessory type"`
	Quantity int    `json:"quantity" validate:"optional,type:number" description:"Quantity included"`
...
type PriceData struct {
	ProductID int     `json:"product_id" validate:"optional,type:number,positive" description:"Product ID identifier"`
	SKU       int     `json:"sku" validate:"optional,type:number,positive" description:"Product SKU identifier"`
	Currency  string  `json:"currency" validate:"optional,type:string,not_empty,min_length:3,max_length:3" description:"Currency code"`
	Price     float64 `json:"price" validate:"optional,type:number,positive" description:"Price value"`
