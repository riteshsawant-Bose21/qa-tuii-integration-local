...
const (
	...
	EndpointFirmwareReleases         = "/firmware/releases"
	EndpointFirmwareReleaseAvailable = "/firmware/releases/:releaseID/mark-available"
	EndpointFirmwareReleaseDeploy    = "/firmware/releases/:releaseID/deploy"
	EndpointBundleDownload           = "/firmware/bundles/:bundleId/download"
	EndpointLogBundleUpdateStatus    = "/firmware/bundles/updates/status"
)
