                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ClaimDeviceRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/devices/histories": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "From time (ISO8601 or timestamp)",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "To time (ISO8601 or timestamp)",
                        "name": "to",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.SpaceRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.ProjectRequest": {
            ...
            "properties": {
                ...
                "metadata": {
                    "description": "JSON string for additional project data",
                    "type": "string"
                },
                "name": {
                    "type": "string"
        ...
        "model.UserMetaData": {
            ...
            "properties": {
                ...
                "personalInfo": {
                    "description": "xyteApiKey is used to store the API key for the XYTE service\nIt is not exposed in the API response and is stored securely.",
                    "type": "object",
                    "properties": {
                        "jobTitle": {
                            "type": "string"
        ...
        "model.UserResponse": {
            ...
            "properties": {
                "created_at": {
                    "description": "MetaData is returned in the response, but sensitive fields like API keys are not included",
                    "type": "string"
                },
                "email": {
                    "type": "string"
