class ResponseCallback<T> {
  ...
  factory ResponseCallback.fromJson(
    dynamic json,
    T Function(Map<String, dynamic>)? fromJsonT,
  ) {

    // Determine success flag, defaulting to true if absent but data structure is unwrapped
    final bool success = json is Map<String, dynamic> ? ((json['status'] == "success") ? true : (!(json.containsKey('status') && json.containsKey('message')))) : true;
    ...
    final dynamic payload =  json is Map<String, dynamic> ? (json.containsKey('updates')) ? json['updates'] : (( json.containsKey('status')) ? json['data'] : json) : json;
