...
extension ConfigationEventsKeys on FusionTestKeys {
  String get events_panel => "events_panel";
  String get events_section => "events_section";
  String get events_section_header => "events";
  String get events_section_headerlabel => "events_section_header_label";
  String get events_section_headericon => "events_section_header_icon";
  String get events_list => "events_list";
  String get events_list_emty => "events_list_empty";
  String get events_list_error => "events_list_error";
  String get events_itm_card_drag_icon => "event_item_card_drag_icon";
  String get events_itm_card_play_icon => "event_item_card_play_icon";
  String get eventsswitch => "event_item_switch_button";
  String get deletevent => "delete_event";
  ...
  String get events_trigger_event_error => "events_trigger_error";
  String get events_trigger_header => "events_trigger_Header";
  String get events_trigger_header_icon => "events_trigger_Header_icon";
  String get eventstriggerheadereditfield => "events_trigger_Header_edit_field";
  String get eventstriggerheaderlabel => "events_trigger_Header_label";
  String get eventtriggerrowheader => "events_trigger_row_header";
  String get eventtriggerrowheadertype => "events_trigger_row_header_type";
  String get eventtriggerrowheaderitem => "events_trigger_row_header_item";
  ...
  String get eventsdeletedialog => "delete_event";
}
