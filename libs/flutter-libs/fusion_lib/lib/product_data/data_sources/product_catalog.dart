...
class ProductCatalog {
  ...
  factory ProductCatalog.fromJson(Map<String, dynamic> json) {
    return ProductCatalog(
      ...
      speakers: (json['speaker'] as List<dynamic>?)
              ?.map((e) => SpeakerProduct.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
      amplifiers: (json['amplifier'] as List<dynamic>?)
              ?.map((e) => AmplifierProduct.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
      controllers: (json['controller'] as List<dynamic>?)
              ?.map(
                  (e) => ControllerProduct.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
      dsps: (json['dsp'] as List<dynamic>?)
              ?.map((e) => DspProduct.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
      accessories: (json['accessory'] as List<dynamic>?)
              ?.map(
                  (e) => AccessoryProduct.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
      ioEndpoints: (json['io_endpoint'] as List<dynamic>?)
              ?.map(
                  (e) => IoEndpointProduct.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
    );
  }
  ...
  @override
  String toString() =>
      'ProductCatalog(version: $version, totalCount: $totalCount)';
}
