...
class DeviceConfigurationPackagePutResponse extends $pb.GeneratedMessage {
  factory DeviceConfigurationPackagePutResponse({
    $core.String? status,
    $0.Struct? updates,
  }) {
    final result = create();
  ...
  DeviceConfigurationPackagePutResponse._();

  factory DeviceConfigurationPackagePutResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory DeviceConfigurationPackagePutResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DeviceConfigurationPackagePutResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'fusion.deviceconfig.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DeviceConfigurationPackagePutResponse clone() =>
      DeviceConfigurationPackagePutResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DeviceConfigurationPackagePutResponse copyWith(
          void Function(DeviceConfigurationPackagePutResponse) updates) =>
      super.copyWith((message) =>
              updates(message as DeviceConfigurationPackagePutResponse))
          as DeviceConfigurationPackagePutResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static DeviceConfigurationPackagePutResponse create() =>
      DeviceConfigurationPackagePutResponse._();
  @$core.override
  DeviceConfigurationPackagePutResponse createEmptyInstance() => create();
  static $pb.PbList<DeviceConfigurationPackagePutResponse> createRepeated() =>
      $pb.PbList<DeviceConfigurationPackagePutResponse>();
  @$core.pragma('dart2js:noInline')
  static DeviceConfigurationPackagePutResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          DeviceConfigurationPackagePutResponse>(create);
  static DeviceConfigurationPackagePutResponse? _defaultInstance;
