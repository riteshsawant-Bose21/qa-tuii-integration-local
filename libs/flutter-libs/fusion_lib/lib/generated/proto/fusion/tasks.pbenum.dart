...
class TaskType extends $pb.ProtobufEnum {
  ...
  static const TaskType TASK_TYPE_SNAPSHOT =
      TaskType._(1, _omitEnumNames ? '' : 'TASK_TYPE_SNAPSHOT');
  static const TaskType TASK_TYPE_MESSAGE =
      TaskType._(2, _omitEnumNames ? '' : 'TASK_TYPE_MESSAGE');
