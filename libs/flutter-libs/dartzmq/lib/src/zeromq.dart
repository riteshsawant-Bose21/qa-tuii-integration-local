  ...
  void _poll() {
    ...
    if (availableEventCount > 0) {
      ...
      for (var eventIdx = 0; eventIdx < availableEventCount; ++eventIdx) {
        ...
        /// Here we can ignore nonfatal error codes like EAGAIN.
        /// Read more on handling errors: https://zguide.zeromq.org/docs/chapter2/
        _checkReturnCode(
          rc,
          ignore: [
            EAGAIN, // EAGAIN error code is 11 on Android/Linux
            EAGAINIOSMACOS, // EAGAIN error code is 35 on iOS/MacOS
            EINTR,
          ],
        );
      }
