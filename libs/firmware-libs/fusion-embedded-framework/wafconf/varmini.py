...
# The Yocto SDK for raphael will set the following ENV variable, among others.
#  CC=aarch64-poky-linux-gcc --sysroot=/opt/bose-raphael/4.14-sumo/sysroots/aarch64-poky-linux
